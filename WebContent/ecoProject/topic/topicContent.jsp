		...
		<header class="header-wrap">
			...
			<nav class="nav">
				<ul class="menubar">
					...
					<li><a href="/ecopang/ecoProject/news/eventList.jp">소식</a></li>
			...
			<table class="topicContentTable">
				<tr>
					...
					<td class="topicContentUserBtn">
						<% if(dto.getUserID().equals((String)session.getAttribute("memId"))) {%>
			...
			<table class="topicLikeReportTable">
				...
				<tr>
					<td class="topicLikeBtn">
						<%if(userID == null){ %>
		         			<button onclick="javascript:likebtn()"> ♧ </button>
		          			x&nbsp;<%=likecount%>
		      			<%}else{%>
		         			<div class="rs">
			...
			<div class="topicCommentDiv">
				...
				<% if(topicCommentList != null) { 
					...
					for(int i = 0; i < topicCommentList.size(); i++) { 
						...
						String img = udao.getUser_img(dto.getUserID());%>
